...
async def get():
    ...
    return {"message": "Chatterbox Milestone 2 - WebSocket Chat Server Running"}
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        await manager.broadcast_system_message(f"{left_user} left due to an error ❌")


if __name__ == "__main__":
    uvicorn.run("ms2:app", host="localhost", port=8000, reload=True)